...
TotalCobradores:=0;	
	writeln ('--------------------------------------------------');
	writeln ('- Cliente Buscado:                               -'); 
	writeln ('--------------------------------------------------');	
	writeln ('- Cobrador:                                      -');
	writeln ('--------------------------------------------------');	
	writeln ('- N - Cliente                   - Plan -  Cuota  -');
	writeln ('--------------------------------------------------');	
		...
		Begin		
			...
			While Clientes <> '' do										// También necesitas un mientras para controlar los clientes
				Begin
					...
					gotoxy (1,7+TotalClientesCob);
					writeln ('-                                                -');
					gotoxy (1,7+TotalClientesCob);
					writeln (TotalClientesCob);
					gotoxy (6,7+TotalClientesCob);
					writeln (Clientes);
